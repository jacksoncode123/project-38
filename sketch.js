...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("The asteroids destroyed the Ship",canvas.width/2-400,canvas.height/2+100);
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("SPACE envaders",canvas.width/2-300,canvas.height/2-300);
    text("welcome to the game!",canvas.width/2-300,canvas.height/2+100);
    stroke("yellow");
    fill("yellow");
    textSize(35);
    textFont("Apple Chancery");
    text("year 3500",canvas.width/2-300,canvas.height/2-250);
    text(" Some asteroids are coming towords your ship.",canvas.width/2-300, canvas.height/2 - 210);
    text("  You are a space fighter.",canvas.width/2-300,canvas.height/2-170);
    text("  Help the ship fight !",canvas.width/2-300,canvas.height/2-130);
    ...
    text("  press 'q' to start game.",canvas.width/2,canvas.height/2-10);
